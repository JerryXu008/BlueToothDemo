...
- (void)viewDidLoad {
    ...
    makeCharacteristicToService(s1, @"FFF5", @"w", @"hello2");//写
    
    makeCharacteristicToService(s1, genUUID(), @"rwn", @"hello3");//读写,通知,自动生成uuid
    //重点研究
    makeCharacteristicToService(s1, @"FFF4", nil, @"hello4");//默认读写字段
    makeCharacteristicToService(s1, @"FFF2", @"rwn", @"hello5");//notify字段
